...
class AddEnglishChampionshipPlayers extends Migration {
	/**
	 * Run the migrations.
	 *
	 * @return void
    ...
    public function getFile(){
        ...
        return json_decode(File::get(storage_path() . '/englishChampionshipScraper.json'), true);   
    }
	...
	public function up()
	{
        ...
        if ($json) {
            ...
            if (! League::whereName('English Football League Championship')->count() ) {
                $league = League::create([
                    'name' => 'English Football League Championship',
                    'sport_id' => $football->id,
                    'badge_image_url' => '/images/leagues/engChamp.png'
                ]);
            }
            else {
            ...
            foreach ($json as $team) {
                ...
                // // now sanitize the players!
                // $playerController = new PlayerController;
                // $playerController->deleteAllKnownAnomalous('Name')
	        } // end foreach
            print_r($teamNames);  
        } // end if
	}
