...
teamToFetch = {
	...
	"Excelsior":"excels",
	"Feyenoord":"feyen",
	"Go Ahead Eagles":"goahead",
	"FC Groningen":"groning",
	"SC Heerenveen":"heeren",
...
for key in teamToFetch:	
	...
	url = "http://www.footballsquads.co.uk/netherl/2014-2015/ere/" + teamToFetch[key] + ".htm"
	r = requests.get(url)
...
# nb: utf-8 support
with io.open('app/storage/dutchEredivisieScraper.json', 'w', encoding='utf-8') as f:
...
json_data=open('app/storage/dutchEredivisieScraper.json')
