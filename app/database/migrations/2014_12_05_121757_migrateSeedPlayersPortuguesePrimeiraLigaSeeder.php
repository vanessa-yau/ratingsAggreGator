...
class MigrateSeedPlayersPortuguesePrimeiraLigaSeeder extends Migration {
	...
	public function getFile(){
	    ...
	    return json_decode(File::get(storage_path() . '/portuguesePrimeiraLigaScraper.json'), true);   
	}
	...
	public function up()
	{
        ...
        if ($json) {
            ...
            if (! League::whereName('Portuguese Primeira Liga')->count() ) {
